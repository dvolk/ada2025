...
#+TITLE: Ada Data Analysis Group Admin Guide
...
You can set the data sources for a given user in your group on the group management page. Simply select the cog icon next to the respective user and tick the data sources that you want them to have access to.

** Removing users from a group

You can remove a user from your group on the group management page. To do so, press the remove user button in their respective row in the users table. 
